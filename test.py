...
# Our libs
from dataset import TestDataset, ValDataset
...
def visualize_result(data, pred, args):
    ...
    # prediction
    pred_color = colorEncode(pred, [2, 3]).astype(np.uint8)
...
def main(args):
    ...
    dataset_test = ValDataset(
        args.test_imgs, args, max_sample=args.num_val)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgMaxSize', default=584, type=int,
    ...
    # Misc arguments
    parser.add_argument('--result', default='/home/sunjesse/scratch/seg',
